...
curl -sSLk  -H "Authorization: Bearer $KUBE_TOKEN" "https://172.17.0.1:10250/configz" | jq '.kubeletconfig|.kind="KubeletConfiguration"|.apiVersion="kubelet.config.k8s.io/v1beta1"' > kubelet_configz_current
